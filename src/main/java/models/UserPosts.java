...
public class UserPosts {
    ...
    public static ArrayList<Post> posts = new ArrayList<>(Arrays.asList(generatePosts()));
    ...
    public static void setAllPosts(List<Post> allPosts) {
        UserPosts.allPosts = allPosts;
    }
